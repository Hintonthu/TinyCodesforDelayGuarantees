function [PhiD, phiD, meanDelay, varDelay, Throughput] = CodedPhiDv2(z,k,K,T,P_kron,pi_I_kron,P00,P01,P10,P11,Px0,Px1,M,N,symbolic)
%Matrix-generating function of delay, coding, new model
    ...
    A1 = z*(P100+P010)+z*(P011+P101)*(z^T*P^T+I2/(I2-f3)-I2)*z*P10;              
    A2 = z*P00+z*P01/(I2-z*Px1)*z*Px0;
    A3 = z*P000+z*P001/(I2-z*Pxx1)*z*Pxx0;
    A4 = z*(P011+P101)*(z^T*P^T+I2/(I2-f3)-I2)*(z*P00+z*P01/(I2-z*Px1)*z*Px0);
    ...
    derivativeA1 = (P100+P010)+(P011+P101)*((T+2)*z^(T+1)*P^T+2*z*I2/(I2-f3)+z^2*I2/(I2-f3)*derivativef3/(I2-f3))*P10-2*z*(P011+P101)*P10;
    ...
    derivativeA4 = (P011+P101)*(z^T*P^T+I2/(I2-f3)-I2)*(z*P00+z*P01/(I2-z*Px1)*z*Px0)...
                 + z*(P011+P101)*(T*z^(T-1)*P^T+I2/(I2-f3)*derivativef3/(I2-f3))*(z*P00+z*P01/(I2-z*Px1)*z*Px0)...
                 + z*(P011+P101)*(z^T*P^T+I2/(I2-f3)-I2)*(P00+2*z*P01/(I2-z*Px1)*Px0+z^2*P01/(I2-z*Px1)*Px1/(I2-z*Px1)*Px0);
    ...
    B1 = ((P100+P010)+(P011+P101)*(z*P^T+I2/(I2-g3)-I2)*P10)/(I2-g1)*((P00+P01*sum2*Px0)+(P01*Px1^(T-k)/(I2-z*Px1^T)*z*sum1*Px0));
    B2 = P000+P001*sum3*Pxx0;
    B3 = P001*Pxx1^(T-k)/(I2-z*Pxx1^T)*z*sum4*Pxx0;
    B4 = (P011+P101)*(z*P^T+I2/(I2-g3)-I2)*((P00+P01*sum2*Px0)+(P01*Px1^(T-k)/(I2-z*Px1^T)*z*sum1*Px0));
    ...
    derivativeB1 = ((P011+P101)*(P^T+I2/(I2-g3)*derivativeg3/(I2-g3))*P10)/(I2-g1)*((P00+P01*sum2*Px0)+(P01*Px1^(T-k)/(I2-z*Px1^T)*z*sum1*Px0))...
                 + ((P100+P010)+(P011+P101)*(z*P^T+I2/(I2-g3)-I2)*P10)/(I2-g1)*derivativeg1/(I2-g1)*((P00+P01*sum2*Px0)+(P01*Px1^(T-k)/(I2-z*Px1^T)*z*sum1*Px0))...
                 + ((P100+P010)+(P011+P101)*(z*P^T+I2/(I2-g3)-I2)*P10)/(I2-g1)*(P01*Px1^(T-k)/(I2-z*Px1^T)*Px1^T/(I2-z*Px1^T)*z*sum1*Px0+P01*Px1^(T-k)/(I2-z*Px1^T)*sum1*Px0);
    ...
    derivativeB4 = (P011+P101)*(P^T+I2/(I2-g3)*derivativeg3/(I2-g3))*((P00+P01*sum2*Px0)+(P01*Px1^(T-k)/(I2-z*Px1^T)*z*sum1*Px0))...
                 + (P011+P101)*(z*P^T+I2/(I2-g3)-I2)*(P01*Px1^(T-k)/(I2-z*Px1^T)*Px1^T/(I2-z*Px1^T)*z*sum1*Px0+P01*Px1^(T-k)/(I2-z*Px1^T)*sum1*Px0);
    ...
    secondderivativeA1 = (P011+P101)*((T+2)*(T+1)*z^T*P^T+2*I2/(I2-f3)+2*z*I2/(I2-f3)*derivativef3/(I2-f3)+2*z*I2/(I2-f3)*derivativef3/(I2-f3)+z^2*I2/(I2-f3)*derivativef3/(I2-f3)*derivativef3/(I2-f3)+z^2*I2/(I2-f3)*secondderivativef3/(I2-f3)+z^2*I2/(I2-f3)*derivativef3/(I2-f3)*derivativef3/(I2-f3))*P10-2*(P011+P101)*P10;
    ...
    secondderivativeA4 = (P011+P101)*(T*z^(T-1)*P^T+I2/(I2-f3)*derivativef3/(I2-f3))*(z*P00+z*P01/(I2-z*Px1)*z*Px0)+(P011+P101)*(z^T*P^T+I2/(I2-f3)-I2)*(P00+2*z*P01/(I2-z*Px1)*Px0+z*P01/(I2-z*Px1)*Px1/(I2-z*Px1)*z*Px0)...
                 ...
                 + (P011+P101)*(z^T*P^T+I2/(I2-f3)-I2)*(P00+2*z*P01/(I2-z*Px1)*Px0+z^2*P01/(I2-z*Px1)*Px1/(I2-z*Px1)*Px0) + z*(P011+P101)*(T*z^(T-1)*P^T+I2/(I2-f3)*derivativef3/(I2-f3))*(P00+2*z*P01/(I2-z*Px1)*Px0+z^2*P01/(I2-z*Px1)*Px1/(I2-z*Px1)*Px0) + z*(P011+P101)*(z^T*P^T+I2/(I2-f3)-I2)*(2*P01/(I2-z*Px1)*Px0+2*z*P01/(I2-z*Px1)*Px1/(I2-z*Px1)*Px0+2*z*P01/(I2-z*Px1)*Px1/(I2-z*Px1)*Px0 +z^2*P01/(I2-z*Px1)*Px1/(I2-z*Px1)*Px1/(I2-z*Px1)*Px0 +z^2*P01/(I2-z*Px1)*Px1/(I2-z*Px1)*Px1/(I2-z*Px1)*Px0);
