function [PhiD, phiD, meanDelay, Throughput] = CumulativeFeedbackPhiDv2(z,k,K,T,P_kron,pi_I_kron,P00,P01,P10,P11,Px0,Px1,M,N,symbolic)
%Matrix-generating function of delay, coding
    ...
    derivativePhiD = k*z^(k-1)*P^k/(I2-P1x_D_1)*(z*P00C+z*P01C/(I2-z*Px1C)*z*(I2-Px1C)+z*P0/(I2-P1x_D_2)*(z*P00+z*P01/(I2-z*Px1)*z*Px0))...
                   + z^k*P^k/(I2-P1x_D_1)*derivativeP1x_D_1/(I2-P1x_D_1)*(z*P00C+z*P01C/(I2-z*Px1C)*z*(I2-Px1C)+z*P0/(I2-P1x_D_2)*(z*P00+z*P01/(I2-z*Px1)*z*Px0))...
                   + z^k*P^k/(I2-P1x_D_1)...
    ...
    if symbolic
        ...
        sum2 = P01C*(1-Px1C^d)/(1-Px1C)*(I2-Px1C);
        ...
        for i = 1:T-1
            ...
            if i<=d
                sum2 = sum2 + P01C*Px1C^(i-1)*(I2-Px1C);     %1st layer where 2DoFs required      
            end
            if i<=d-1
    ...
    %STATE C2 & self loop: Px0C -> (I2-Px1C) because in my definition,
    %Px0C+Px1C \neq I2
    Phitau = z*P^(T-d-1)/(I2-P1x_T_1)*(P01C*Px1C^d/(I2-z*Px1C^T)*z*sum1*(I2-Px1C)...
                                     +P00C+sum2...
    ...
    derivativePhitau = P^(T-d-1)/(I2-P1x_T_1)*(P01C*Px1C^d/(I2-z*Px1C^T)*z*sum1*(I2-Px1C)...
                                     +P00C+sum2...
                                     +P0/(I2-P1x_T_2)*(P00+sum3+P01*Px1^(d-1)/(I2-z*Px1^T)*z*sum4*Px0))...
                     + z*P^(T-d-1)/(I2-P1x_T_1)*derivativeP1x_T_1/(I2-P1x_T_1)*(P01C*Px1C^d/(I2-z*Px1C^T)*z*sum1*(I2-Px1C)...
                                     +P00C+sum2...
                                     +P0/(I2-P1x_T_2)*(P00+sum3+P01*Px1^(d-1)/(I2-z*Px1^T)*z*sum4*Px0))...
                     + z*P^(T-d-1)/(I2-P1x_T_1)...
                     *(P01C*Px1C^d/(I2-z*Px1C^T)*(Px1C^T)/(I2-z*Px1C^T)*z*sum1*(I2-Px1C)+P01C*Px1C^d/(I2-z*Px1C^T)*sum1*(I2-Px1C)...                                  
